 ...
 * them directly. Reminders are generated by the Firebase scheduled sender, which
 ...
 * Firebase scheduled sender which recomputes from tasks + assignments each run.
 */
