...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'How to join from a shared link', text: 'Open the task link from WhatsApp. Sign in or register if requested; the app returns you to the same task after authentication or email verification. Review the date, location, and availability, then choose Confirm signup. Full, cancelled, completed, deleted, and past tasks cannot accept signup.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'How to share a task', text: 'The task creator opens Tasks > Create & Manage, finds the dated task, and chooses Share task. On a phone, use the device share menu to select WhatsApp; when native sharing is unavailable, the app opens WhatsApp directly with the task details and link. The link works for existing and newly created tasks.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Sharing your task', text: 'Choose Share task beside a task you created to send its direct link through WhatsApp or another phone app. Recipients sign in or register, return to that exact task, and confirm signup. The link also works for tasks created before this feature was added.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Quiet hours', text: 'WhatsApp task reminders are not sent from 9:00 PM through 7:59 AM Eastern Time. A reminder due overnight moves to approximately 8:07 AM when that remains before the task. For an early-morning task, it moves to approximately 8:07 PM the previous evening. Task forms preview the adjustment; if no permitted delivery window remains, the reminder is shown and recorded as unavailable rather than being sent after the task starts.' },
